...
- For your general personal development, check out the UU Development Guide on [intranet](https://intranet.uu.nl/development-guide)
- For privacy, check out our own [Data Privacy Handbook](https://utrechtuniversity.github.io/dataprivacyhandbook/) 
- For a general intro in to RDM, either check [RDMLA](https://rdmla.github.io/)
- or [Essentials 4 Data Support](https://datasupport.researchdata.nl/en/)
- For a general intro to FAIR check out [FAIR 101](https://au-research.github.io/FAIR-data-101-training/)
- [Library Carpentry](https://librarycarpentry.org/lessons/)
- [Open Science MOOC](https://opensciencemooc.eu/)
- [Understanding the GDPR](https://www.futurelearn.com/courses/general-data-protection-regulation)
